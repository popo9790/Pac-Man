...
static void draw_speed_gomu(Map* M, const int row, const int col);
static void draw_tele(Map* M, const int row, const int col);
...
void draw_map(Map const* M) {
    tele_x = (int*)malloc(tele_num * sizeof(int));
    tele_y = (int*)malloc(tele_num * sizeof(int));
...
static void draw_speed_gomu(Map* M, const int row, const int col){
    al_draw_filled_circle(map_offset_x + col * block_width + block_width / 2.0, map_offset_y + row * block_height + block_height / 2.0, block_width / 3.0, al_map_rgb(0, 255, 0));
}

static void draw_tele(Map* M, const int row, const int col){
    al_draw_filled_circle(map_offset_x + col * block_width + block_width / 2.0, map_offset_y + row * block_height + block_height / 2.0, block_width / 3.0, al_map_rgb(0, 0, 255));
}
